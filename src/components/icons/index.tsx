...
const icons = {
  ...
  ICON_USER: <AiOutlineUser className='text-[20px]!' />,
  ...
  ICON_PAYMENT: <MdPayment className='text-[#08979c]! text-[16px]!' />,
  ICON_SETTING: <AiFillSetting className='text-[16px]!' />,
  ICON_WITHDRAW_REQUEST: <AiFillCreditCard className='text-[16px]!' />,
  ICON_UPLOAD: <AiOutlineCloudUpload className='text-[16px]!' />,
