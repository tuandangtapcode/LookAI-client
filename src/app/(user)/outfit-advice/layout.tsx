...
const OutfitAdviceLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className='flex flex-col lg:flex-row gap-x-6 h-[calc(100vh-124px)] overflow-hidden'>
      <div className='hidden lg:block lg:w-1/4 bg-white shadow-lg px-4 pt-3 overflow-y-auto rounded-r-2xl border-r border-gray-200'>
      ...
      <div className='w-full lg:w-3/4 px-4 lg:px-0'>
        ...
        <div className='h-[calc(100%-60px)] overflow-y-auto overflow-x-hidden bg-white rounded-2xl shadow-lg p-6 border border-gray-100'>
          {children}
        </div>
      </div>
    </div>
